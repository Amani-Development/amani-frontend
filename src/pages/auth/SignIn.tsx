...
//redux
import {clearErrors, loginUser, ValidateEmailAndPassword} from "store/actions";
//helpers
        ...
        <div className="lg:grid lg:grid-cols-3 p-8">
            ...
            <div className="lg:py-52 max-h-screen h-screen">
                <div className="login-logo">
                    ...
                    <div className="py-3">
                        <button type="button"
                                className="flex items-center justify-center w-full py-4 rounded-3xl text-xs text-black shadow-sm solid-br bg-[#FFFFFF] text-center inline-flex items-center  ">
                            <svg className="w-5 h-5 me-2 -ms-1" aria-hidden="true" focusable="false" data-prefix="fab"
                                 data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" width="2443"
                                 height="2500" preserveAspectRatio="xMidYMid" viewBox="0 0 256 262" id="google">
                                <path fill="#4285F4"
                    ...
                    <div>
                        <button type="button"
                                className="flex items-center justify-center w-full py-4 rounded-3xl text-xs text-white bg-[#38393D] text-center inline-flex items-center  ">
                            <svg className="w-5 h-5 me-2 -ms-1" aria-hidden="true" focusable="false" data-prefix="fab"
                ...
                <div className="flex items-center justify-center py-4 text-xs ">
                    <p className="text-[#717279]">New to Amani?</p> <span className="text-[#4C7F00]"
                                                                          style={{textDecoration: 'underline'}}>Sign Up!</span>
                </div>
            </div>
            <div></div>
        </div>
