        ...
        <div>
          ...
          <div className="Hero_container">
            ...
            <div className="hero_sub_text">
              ...
              <span className="hero_text_green">connect </span> <br /> easily to
              Landlords
            </div>
            ...
            >
              <div className="section_1_main">
                <div className="section_1_text">
                  Easily put up your properties <br /> for sale, browse verified{" "}
                  <br /> listing, schedule viewings, <br /> and apply for
                  rentals directly <br /> through our platform
                </div>
          ...
          <div className="Section_4_container">
            <div className="section_4_first">
              ...
              <div className="section_4_first_textcontainer">
                <div className="section_4_first_text">Amani for Tenants:</div>
                ...
                <ul className="section_4_first_list">
                  <li className="section_4_first_listItem">
                    ...
                    <div>Direct connection between landlords and tenants.</div>
                  </li>
                  <li className="section_4_first_listItem">
                    <span className="dot">•</span>
                  ...
                  <li className="section_4_first_listItem">
                    <span className="dot">•</span>
                    <div> Access to a wider pool of properties.</div>
                  </li>
                  <li className="section_4_first_listItem">
                    <span className="dot">•</span>
                    <div> Streamlined search and application processes.</div>
                  </li>
                  <li className="section_4_first_listItem">
                    <span className="dot">•</span>
                    <div> Secure and transparent transactions.</div>
                  </li>
                </ul>
              </div>
            </div>
            ...
            >
              ...
              />
              <div className="section_4_first_textcontainer">
                <div className="section_4_first_text">Amani for Landlord:</div>
                <div className="section_4_first_subText">
